...
combined_forecast_url = 'https://raw.githubusercontent.com/Susanto7an/Tan-Portfolio/main/Plotly%20Dashboard%201/datasets/combined_forecast2.csv'
data = pd.read_csv(combined_forecast_url)
