...
state_sales_data_url = 'https://raw.githubusercontent.com/Susanto7an/Tan-Portfolio/main/Plotly%20Dashboard%201/datasets/state_sales_data.csv'

state_sales_monthly_url = 'https://raw.githubusercontent.com/Susanto7an/Tan-Portfolio/main/Plotly%20Dashboard%201/datasets/state_sales_quarterly'

store_sales_data_url = 'https://raw.githubusercontent.com/Susanto7an/Tan-Portfolio/main/Plotly%20Dashboard%201/datasets/store_sales_data.csv'

store_sales_monthly_url = 'https://raw.githubusercontent.com/Susanto7an/Tan-Portfolio/main/Plotly%20Dashboard%201/datasets/store_sales_quarterly'

state_sales_data = pd.read_csv(state_sales_data_url)
store_sales_data = pd.read_csv(store_sales_data_url)
store_sales_monthly = pd.read_csv(store_sales_monthly_url)
state_sales_monthly = pd.read_csv(state_sales_monthly_url)
    ...
    dbc.Row([
        dbc.Col([
            dcc.Dropdown(id='dropdown3', multi=False,
                         value=state_sales_monthly['state'][0],
                         options=[{'label': x, 'value': x} for x in sorted(state_sales_monthly['state'].unique())],
                         ),
        ...
        dbc.Col([
            dcc.Dropdown(id='dropdown4', multi=False,
                         value=store_sales_monthly['store_type'][0],
                         options=[{'label': x, 'value': x} for x in sorted(store_sales_monthly['store_type'].unique())],
                         ),
